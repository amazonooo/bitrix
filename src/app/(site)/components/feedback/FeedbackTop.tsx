			...
			<div className='flex flex-col lg:flex-row justify-between'>
				<div className='flex flex-col lg:order-1 order-2 px-5 lg:px-0'>
					...
					<p className='text-xl font-medium lg:font-normal mb-7 lg:mb-[60px] max-w-[460px]'>
						Настроим ваш отдел продаж, выявим любые проблемные моменты. Оставьте
						ваш номер телефона, и наши менеджеры свяжутся с вами!
					</p>
					<form className='flex flex-col'>
						...
						<Button link='/' className='lg:w-[240px] mb-7'>Получить аудит</Button>
					</form>
				</div>
