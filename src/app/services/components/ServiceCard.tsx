...
export default function ServiceCard(card: IServiceCard) {
	return (
		<article className='h-auto md:h-[415px] md:px-10 md:pt-10 flex flex-col md:border md:border-use-gray rounded-xl group hover:border-transparent hover:bg-sky transition-all duration-300'>
