...
export default function Advantages() {
  return (
		<section>
			...
			<div className='w-full border-b border-b-use-gray pb-[30px] lg:pb-0'>
				<div className='flex flex-col lg:flex-row lg:items-center lg:gap-x-6'>
					...
					<p className='text-start flex flex-1 items-center justify-between lg:py-7 font-bold text-xl transition-all [&[data-state=open]>svg]:rotate-180'>
						Владельцем прав на приложение является заказчик 
					</p>
				</div>
			</div>
			<div className='w-full border-b border-b-use-gray py-[30px] lg:py-0'>
				<div className='flex flex-col lg:flex-row lg:items-center lg:gap-x-6'>
					<span className='text-[2.5rem] lg:text-5xl text-primary-blue font-bold mr-2'>
						2
					</span>
